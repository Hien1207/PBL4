...
require dirname(__DIR__) . "/database/News.php";
...
class Chat implements MessageComponentInterface {
    ...
    public function onMessage(ConnectionInterface $from, $msg) {
        ...
        echo sprintf('Connection %d sending data "%s" to %d other connection%s' . "\n"
        ...
        $chat_object->setContent($data['Content']);
